...
hero:
  name: NextAuth
  text: Authentication for Next.js 16!
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/zitadel/next-auth

features:
  - title: OAuth
    details: Effortlessly connect your Next.js 16 application with Google, GitHub, Azure and countless others.
  ...
  - title: Made for Next.js 16
    details: Deep integrations with the Next.js 16 framework.
